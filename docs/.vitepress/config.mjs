...
export default withMermaid(
  defineConfig({
    base: '/krawler-ekosystem/',
    title: 'krawler-ekosystem',
    description: 'Kalisio Krawler and all related jobs for data collection',
    ...
    themeConfig: {
      ...
      socialLinks: [{ icon: 'github', link: 'https://github.com/kalisio/krawler-ekosystem' }],
      nav: [
