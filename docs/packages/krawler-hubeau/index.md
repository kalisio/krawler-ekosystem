---
title: krawler-hubeau
description: A Krawler based job to download data from the Hub'Eau API.
---

# krawler-hubeau

_A Krawler based job to download data from French open portal [Hub'Eau](https://hubeau.eaufrance.fr/)._
...
The **krawler-hubeau-hydro** jobs allow to scrape hydrometric data from the following api: [http://hubeau.eaufrance.fr/page/api-hydrometrie](http://hubeau.eaufrance.fr/page/api-hydrometrie). The downloaded data are stored in a [MongoDB](https://www.mongodb.com/) database and more precisely in 2 collections:
...
The **krawler-hubeau-piezo** jobs allow to scrape piezometric data from the following api: [http://hubeau.eaufrance.fr/page/api-piezometrie](http://hubeau.eaufrance.fr/page/api-piezometrie). The downloaded data are stored in a [MongoDB](https://www.mongodb.com/) database and more precisely in 2 collections:
